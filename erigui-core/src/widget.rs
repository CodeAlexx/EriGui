use crate::{Point, Rect, Size, WidgetId, Event, LayoutConstraints, Theme};
use std::any::Any;
...
pub trait DrawContext {
    ...
    fn draw_gradient_rect(&mut self, rect: Rect, top_color: crate::Color, bottom_color: crate::Color, horizontal: bool);
    
    fn draw_shadow(&mut self, rect: Rect, shadow_color: crate::Color, blur_radius: i32, offset: Point);
