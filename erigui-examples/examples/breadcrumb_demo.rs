...
impl BreadcrumbDemo {
    ...
    fn update_path_label(&mut self) {
        ...
        self.path_label
            .set_text(format!("Current path: {}", path_str));
    }
}
    ...
    event_loop.run(move |event, elwt| {
        ...
        match event {
            ...
            WinitEvent::WindowEvent { event: WindowEvent::RedrawRequested, .. } => {
                ...
                // Buttons
                let button_size = demo
                    .add_button
                    .measure(&LayoutConstraints::default(), &theme);
                demo.add_button.layout(
                    Rect::new(padding, y, button_size.width, button_size.height),
                    &theme,
                );
                ...
                let path_size = demo
                    .path_label
                    .measure(&LayoutConstraints::default(), &theme);
                demo.path_label.layout(
                    Rect::new(padding, y, path_size.width, path_size.height),
                    &theme,
                );
                ...
                renderer.set_color(theme.colors.text_secondary);
                renderer.draw_text(
