...
impl DateTimePickerDemo {
    fn new() -> Self {
        ...
        Self {
            ...
            datetime_picker,
            custom_picker,
            info_label: Label::new(WidgetId::default(), "DateTimePicker Demo - Click calendar button to select"),
        ...
        *control_flow = ControlFlow::Wait;
        ...
        match event {
            ...
            WinitEvent::RedrawRequested(_) => {
                ...
                // Date picker
                demo.date_picker.layout(Rect::new(
                    padding,
                    y,
                    picker_width,
                    picker_height
                ...
                // Time picker
                demo.time_picker.layout(Rect::new(
                ...
                // DateTime picker
                demo.datetime_picker.layout(Rect::new(
                    padding,
                    y,
                    picker_width,
                    picker_height
                ...
                // Custom format picker
                demo.custom_picker.layout(Rect::new(
                    padding + picker_width + 40,
                    y,
                    picker_width,
                    picker_height
                ...
                label_renderer.draw_text(
                    "Time Only (24-hour):",
                    Point::new(padding + picker_width + 40, demo.time_picker.bounds().y() - 20),
                    theme.typography.font_size_small
                );
                ...
                label_renderer.draw_text(
                    ...
                    Point::new(padding + picker_width + 40, demo.custom_picker.bounds().y() - 20),
                    theme.typography.font_size_small
                );
                
                // Draw pickers
                demo.date_picker.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.time_picker.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.datetime_picker.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.custom_picker.draw(&mut renderer as &mut dyn DrawContext, &theme);
