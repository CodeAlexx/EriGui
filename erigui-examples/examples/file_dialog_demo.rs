    ...
    fn new() -> Self {
        ...
        Self {
            ...
            info_label: Label::new(
                WidgetId::default(),
                "FileDialog Demo - Click a button to open a dialog",
            ),
...
fn main() {
    ...
    let mut renderer =
        Renderer::new(&event_loop, 800, 600, "FileDialog Demo").expect("Failed to create renderer");
        ...
        match event {
            WinitEvent::WindowEvent { event, .. } => {
                    ...
                    erigui_rendering::window::convert_window_event(event, renderer.viewport_size())
                {
                    ...
                    if demo.show_open {
                        if demo.open_dialog.handle_event(&gui_event, &theme)
