...
impl SearchBoxDemo {
    fn new() -> Self {
        ...
        Self {
            ...
            history_label: Label::new(WidgetId::default(), "SearchBox with History (click when empty):"),
            suggestion_label: Label::new(WidgetId::default(), "SearchBox with Suggestions:"),
            result_label: Label::new(WidgetId::default(), "Press Enter to search, Escape to close suggestions"),
    ...
    fn handle_search(&mut self, query: &str) {
        ...
        let result_text = if query.is_empty() {
            ...
            format!("Found {} results for '{}'", self.search_results.len(), query)
        };
...
fn main() {
    ...
    let mut renderer = Renderer::new(&event_loop, 800, 600, "SearchBox Demo")
        ...
        *control_flow = ControlFlow::Wait;
        ...
        match event {
            ...
            WinitEvent::RedrawRequested(_) => {
                ...
                // Basic search
                let basic_label_size = demo.basic_label.measure(&LayoutConstraints::default(), &theme);
                demo.basic_label.layout(Rect::new(
                ...
                demo.basic_search.layout(Rect::new(
                    (window_size.width - search_width) / 2,
                    y,
                    search_width,
                    search_height
                ...
                // History search
                let history_label_size = demo.history_label.measure(&LayoutConstraints::default(), &theme);
                demo.history_label.layout(Rect::new(
                    (window_size.width - search_width) / 2,
                    y,
                ...
                demo.history_search.layout(Rect::new(
                    (window_size.width - search_width) / 2,
                    y,
                    search_width,
                    search_height
                ...
                // Suggestion search
                let suggestion_label_size = demo.suggestion_label.measure(&LayoutConstraints::default(), &theme);
                demo.suggestion_label.layout(Rect::new(
                    (window_size.width - search_width) / 2,
                    y,
                ...
                demo.suggestion_search.layout(Rect::new(
                    (window_size.width - search_width) / 2,
                    y,
                    search_width,
                    search_height
                ...
                demo.basic_label.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.basic_search.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.history_label.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.history_search.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.suggestion_label.draw(&mut renderer as &mut dyn DrawContext, &theme);
                demo.suggestion_search.draw(&mut renderer as &mut dyn DrawContext, &theme);
