...
impl TreeViewDemo {
    fn new() -> Self {
        ...
        documents.add_child(TreeNode::new(
            "resume.pdf".to_string(),
            "resume.pdf".to_string(),
        ));
        documents.add_child(TreeNode::new(
            "cover_letter.doc".to_string(),
            "cover_letter.doc".to_string(),
        ));
        ...
        rust_project.add_child(TreeNode::new(
        ...
        projects.add_child(TreeNode::new(
            "python_proj".to_string(),
        ...
        pictures.add_child(TreeNode::new(
            "vacation2023".to_string(),
            "Vacation 2023".to_string(),
        ));
        pictures.add_child(TreeNode::new(
            "family".to_string(),
        ...
        downloads.add_child(TreeNode::new(
        ...
        server2.add_child(TreeNode::new(
            "archives".to_string(),
            "Archives".to_string(),
        ));
        ...
        let label = Label::new(
            WidgetId::default(),
            "Click on items to select and expand/collapse",
        );
    ...
    fn handle_selection(&mut self, node_id: &str) {
        ...
        if let Some(path) = find_path(&self.tree_view.root_nodes, node_id, "") {
            ...
            self.label
                .set_text(format!("Selected: {}", self.selected_path));
        }
    }
}
    ...
    event_loop.run(move |event, elwt| {
        ...
        match event {
            WinitEvent::WindowEvent { event, .. } => {
                ...
                if let Some(mut gui_event) = translator.translate(&event) {
