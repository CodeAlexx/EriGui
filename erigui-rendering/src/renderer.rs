use crate::{FontRenderer, GlContext};
...
impl DrawContext for Renderer {
    ...
    fn draw_gradient_rect(
        ...
        self.gl
            .draw_gradient_rect(rect, top_color, bottom_color, horizontal);
    }
    ...
    fn draw_image_rgba(&mut self, rect: Rect, width: i32, height: i32, data: &[u8]) {
        self.gl.draw_image_rgba(rect, width, height, data);
    }
}
