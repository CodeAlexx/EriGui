...
impl Icon {
    pub fn draw_back_arrow(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        let points = vec![
            ...
            Point::new((center.x as f32 + size * 0.2) as i32, (center.y as f32 - size * 0.4) as i32),
            Point::new((center.x as f32 + size * 0.2) as i32, (center.y as f32 + size * 0.4) as i32),
        ];
    ...
    pub fn draw_up_arrow(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        let points = vec![
            ...
            Point::new((center.x as f32 - size * 0.4) as i32, (center.y as f32 + size * 0.2) as i32),
            Point::new((center.x as f32 + size * 0.4) as i32, (center.y as f32 + size * 0.2) as i32),
        ];
    ...
    pub fn draw_refresh(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        for i in 0..segments {
            ...
            let angle2 = start_angle + (end_angle - start_angle) * ((i + 1) as f32) / (segments as f32);
    ...
    pub fn draw_chevron_right(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        let points = vec![
            Point::new((center.x as f32 - size * 0.3) as i32, (center.y as f32 - size * 0.5) as i32),
            Point::new((center.x as f32 + size * 0.3) as i32, center.y),
            Point::new((center.x as f32 - size * 0.3) as i32, (center.y as f32 + size * 0.5) as i32),
        ];
    ...
    pub fn draw_gear(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        context.fill_ellipse(center, (inner_radius * 0.5) as i32, (inner_radius * 0.5) as i32, 16);
    }
    ...
    pub fn draw_palette(context: &mut dyn DrawContext, bounds: Rect, color: Color) {
        ...
        context.fill_ellipse(palette_center, (width * 0.5) as i32, (height * 0.4) as i32, 32);
        
        // Draw thumb hole
        context.set_color(color.with_alpha(0));
        let hole_x = (center.x as f32 - width * 0.2) as i32;
        let hole_y = (center.y as f32 - height * 0.1) as i32;
        context.fill_ellipse(Point::new(hole_x, hole_y), (width * 0.15) as i32, (height * 0.15) as i32, 16);
    }
